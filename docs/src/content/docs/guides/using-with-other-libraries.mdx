...
Checkmate is written in TypeScript and can be used with any JavaScript framework or library.

If you are using a library that is not officially supported, you can still use Checkmate with it. You will have to create your library-specific bindings to work with the library.

## Installation

To use Checkmate with other libraries, you need to install the core package using your favorite package manager.

<PackageManagers pkg="@genshi/core" />

## Usage

Checkmate provides a `Store` class that you can use to create a store for your application. Everything you need to manage your application state is provided by the `Store` class.
