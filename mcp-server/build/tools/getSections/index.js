import { z } from 'zod';
export default function registerGetSections(server, makeRequest) {
    server.tool('get-sections', 'Retrieve list of sections for a project (optionally scoped to a run)', {
